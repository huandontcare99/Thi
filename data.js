/* data.js — dữ liệu cho Quiz Pro
   CÁCH 1 (khuyên dùng): JSON dễ sửa — chỉ cần thêm bớt môn/câu trong mảng dưới.
   CÁCH 2 (tương thích cũ): Dán nguyên văn TXT theo format "Câu x: … / Đáp án đúng: … / Tất cả đáp án: A. …" vào RAW_*.
*/
...
//     {
//       id: "ph",
//       name: "Phát triển ứng dụng Web (Mở nguồn)",
//       questions: [
//         // Ví dụ 2 câu mẫu — bạn thêm bao nhiêu cũng được
//         { id:"ph-1", qnum:1, text:"CSS dùng để làm gì?", options:["Định dạng","Lưu trữ","Tính toán","Kết nối CSDL"], answer:0, explain:"CSS định dạng giao diện, màu sắc, bố cục." },
//         { id:"ph-2", qnum:2, text:"Thẻ nào chứa metadata trang?", options:["<body>","<head>","<main>","<footer>"], answer:1 }
//       ]
//     },
//     {
//       id: "qu",
...
//       questions: [
//         { id:"qu-1", qnum:1, text:"Dự án là gì?", options:[
//           "Nỗ lực tạm thời tạo ra SP/DV duy nhất",
//           "Hoạt động thường nhật lặp lại",
//           "Nhiệm vụ không mục tiêu",
//           "Kế hoạch không ràng buộc"
//         ], answer:0, explain:"Theo PMBOK, dự án là nỗ lực tạm thời để tạo sản phẩm/dịch vụ duy nhất." }
//       ]
//     }
//   ]
// };

// ===== CÁCH 2: LEGACY TXT (TÙY CHỌN) =====
// Nếu bạn muốn dán nguyên văn 2 file .txt cũ, bỏ comment dưới và dán vào giữa 2 cặp backtick.
// Khi CÁCH 1 có dữ liệu, CÁCH 2 sẽ bị bỏ qua.
...
// Giữ tương thích API cũ (nếu bạn dùng cách TXT)
window.quizData = {
  getAll() {
    const arr = [];
    if (typeof RAW_PH === "string") arr.push({ id:"ph", subject: "Phát triển ứng dụng Web (Mở nguồn)", text: RAW_PH });
    if (typeof RAW_QU === "string") arr.push({ id:"qu", subject: "Quản trị dự án CNTT", text: RAW_QU });
    return arr;
  },
};
